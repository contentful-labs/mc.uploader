...
var rateLimitThrottle = function () {
  ...
  return new Promise(function (resolve) {
    ...
    }, Math.floor(requestCount / requestsPerSecond) * 5000);
  });
};
                      ...
                      return rateLimitThrottle()
                          .then(function () {
                            ...
                            return request({
                              ...
                              headers: {
                                'Authorization': 'Bearer ' + cmd.token,
                                'X-Contentful-Version': sysVersion + 1
                              }
                            });
                          })
                          .catch(function (err) {
